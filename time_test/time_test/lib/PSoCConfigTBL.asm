...
export LoadConfigTBL_time_test_Bank1
export LoadConfigTBL_time_test_Bank0
export LoadConfigTBL_time_test_Ordered
AREA lit(rom, rel)
LoadConfigTBL_time_test_Bank0:
...
;       Instance name ADCINC_1, Block Name PWM(DCB13)
	db		3fh, 00h		;ADCINC_1_PWMcr0(DCB13CR0)
	db		3dh, 00h		;ADCINC_1_PWMdr1(DCB13DR1)
	db		3eh, 01h		;ADCINC_1_PWMdr2(DCB13DR2)
;  Instance name AMUX4_1, User Module AMUX4
;  Instance name DigBuf_1, User Module DigBuf
;       Instance name DigBuf_1, Block Name DigBuf(DBB20)
	db		43h, 03h		;DigBuf_1_CONTROL_REG(DBB20CR0)
	db		41h, 00h		;DigBuf_1_DATA_1_REG(DBB20DR1)
	db		42h, 00h		;DigBuf_1_DATA_2_REG(DBB20DR2)
...
;       Instance name PWM16_1, Block Name PWM16_LSB(DBB00)
	...
	db		21h, 80h		;PWM16_1_PERIOD_LSB_REG(DBB00DR1)
	db		22h, 40h		;PWM16_1_COMPARE_LSB_REG(DBB00DR2)
;       Instance name PWM16_1, Block Name PWM16_MSB(DBB01)
	db		27h, 00h		;PWM16_1_CONTROL_MSB_REG(DBB01CR0)
	db		25h, 0ch		;PWM16_1_PERIOD_MSB_REG(DBB01DR1)
	db		26h, 06h		;PWM16_1_COMPARE_MSB_REG(DBB01DR2)
;  Instance name PWM8_1, User Module PWM8
;       Instance name PWM8_1, Block Name PWM8(DBB10)
	db		33h, 00h		;PWM8_1_CONTROL_REG(DBB10CR0)
	db		31h, ffh		;PWM8_1_PERIOD_REG(DBB10DR1)
	db		32h, 0ah		;PWM8_1_COMPARE_REG(DBB10DR2)
;  Instance name PWM8_2, User Module PWM8
;       Instance name PWM8_2, Block Name PWM8(DBB21)
	db		47h, 00h		;PWM8_2_CONTROL_REG(DBB21CR0)
	db		45h, f0h		;PWM8_2_PERIOD_REG(DBB21DR1)
	db		46h, 0ah		;PWM8_2_COMPARE_REG(DBB21DR2)
;  Instance name TX8_1, User Module TX8
;       Instance name TX8_1, Block Name TX8(DCB23)
	db		4fh, 00h		;TX8_1_CONTROL_REG  (DCB23CR0)
	db		4dh, 00h		;TX8_1_TX_BUFFER_REG(DCB23DR1)
	db		4eh, 00h		;TX8_1_(DCB23DR2)
;  Instance name Timer16_1, User Module Timer16
;       Instance name Timer16_1, Block Name TIMER16_LSB(DCB02)
	db		2bh, 00h		;Timer16_1_CONTROL_LSB_REG(DCB02CR0)
	db		29h, 28h		;Timer16_1_PERIOD_LSB_REG(DCB02DR1)
	db		2ah, 14h		;Timer16_1_COMPARE_LSB_REG(DCB02DR2)
;       Instance name Timer16_1, Block Name TIMER16_MSB(DCB03)
	db		2fh, 04h		;Timer16_1_CONTROL_MSB_REG(DCB03CR0)
	db		2dh, 00h		;Timer16_1_PERIOD_MSB_REG(DCB03DR1)
	db		2eh, 00h		;Timer16_1_COMPARE_MSB_REG(DCB03DR2)
;  Instance name Timer16_2, User Module Timer16
;       Instance name Timer16_2, Block Name TIMER16_LSB(DBB11)
	db		37h, 00h		;Timer16_2_CONTROL_LSB_REG(DBB11CR0)
	db		35h, 00h		;Timer16_2_PERIOD_LSB_REG(DBB11DR1)
	db		36h, 00h		;Timer16_2_COMPARE_LSB_REG(DBB11DR2)
;       Instance name Timer16_2, Block Name TIMER16_MSB(DCB12)
	db		3bh, 04h		;Timer16_2_CONTROL_MSB_REG(DCB12CR0)
	db		39h, fah		;Timer16_2_PERIOD_MSB_REG(DCB12DR1)
	db		3ah, 00h		;Timer16_2_COMPARE_MSB_REG(DCB12DR2)
;  Global Register values Bank 0
	db		60h, 60h		; AnalogColumnInputSelect register (AMX_IN)
	...
	db		e7h, 43h		; DecimatorControl_1 register (DEC_CR1)
	...
	db		c5h, 10h		; Row_2_OutputDrive_0 register (RDI2SRO0)
	db		c6h, 12h		; Row_2_OutputDrive_1 register (RDI2SRO1)
	...
	db		ffh
LoadConfigTBL_time_test_Bank1:
;  Instance name ADCINC_1, User Module ADCINC
;       Instance name ADCINC_1, Block Name ADC(ASC10)
;       Instance name ADCINC_1, Block Name PWM(DCB13)
	db		3ch, 31h		;ADCINC_1_PWMfn(DCB13FN)
	db		3dh, 15h		;ADCINC_1_PWMsl(DCB13IN)
	db		3eh, 40h		;ADCINC_1_PWMos(DCB13OU)
;  Instance name AMUX4_1, User Module AMUX4
;  Instance name DigBuf_1, User Module DigBuf
;       Instance name DigBuf_1, Block Name DigBuf(DBB20)
	db		40h, 22h		;DigBuf_1_FUNC_REG(DBB20FN)
	db		41h, e0h		;DigBuf_1_INPUT_REG(DBA20IN)
	db		42h, 00h		;DigBuf_1_OUTPUT_REG(DBA20OU)
;  Instance name PGA_1, User Module PGA
;       Instance name PGA_1, Block Name GAIN(ACB00)
;  Instance name PWM16_1, User Module PWM16
;       Instance name PWM16_1, Block Name PWM16_LSB(DBB00)
	db		20h, 01h		;PWM16_1_FUNC_LSB_REG(DBB00FN)
	db		21h, 17h		;PWM16_1_INPUT_LSB_REG(DBB00IN)
	db		22h, 40h		;PWM16_1_OUTPUT_LSB_REG(DBB00OU)
;       Instance name PWM16_1, Block Name PWM16_MSB(DBB01)
	db		24h, 29h		;PWM16_1_FUNC_MSB_REG(DBB01FN)
	db		25h, 37h		;PWM16_1_INPUT_MSB_REG(DBB01IN)
	db		26h, 47h		;PWM16_1_OUTPUT_MSB_REG(DBB01OU)
;  Instance name PWM8_1, User Module PWM8
;       Instance name PWM8_1, Block Name PWM8(DBB10)
	db		30h, 21h		;PWM8_1_FUNC_REG(DBB10FN)
	db		31h, 17h		;PWM8_1_INPUT_REG(DBB10IN)
	db		32h, 44h		;PWM8_1_OUTPUT_REG(DBB10OU)
;  Instance name PWM8_2, User Module PWM8
;       Instance name PWM8_2, Block Name PWM8(DBB21)
	db		44h, 21h		;PWM8_2_FUNC_REG(DBB21FN)
	db		45h, 14h		;PWM8_2_INPUT_REG(DBB21IN)
	db		46h, 06h		;PWM8_2_OUTPUT_REG(DBB21OU)
;  Instance name TX8_1, User Module TX8
;       Instance name TX8_1, Block Name TX8(DCB23)
	db		4ch, 0dh		;TX8_1_FUNC_REG     (DCB23FN)
	db		4dh, 01h		;TX8_1_INPUT_REG    (DCB23IN)
	db		4eh, 47h		;TX8_1_OUTPUT_REG   (DCB23OU)
;  Instance name Timer16_1, User Module Timer16
;       Instance name Timer16_1, Block Name TIMER16_LSB(DCB02)
	db		28h, 00h		;Timer16_1_FUNC_LSB_REG(DCB02FN)
	db		29h, 17h		;Timer16_1_INPUT_LSB_REG(DCB02IN)
	db		2ah, 40h		;Timer16_1_OUTPUT_LSB_REG(DCB02OU)
;       Instance name Timer16_1, Block Name TIMER16_MSB(DCB03)
	db		2ch, 28h		;Timer16_1_FUNC_MSB_REG(DCB03FN)
	db		2dh, 37h		;Timer16_1_INPUT_MSB_REG(DCB03IN)
	db		2eh, 68h		;Timer16_1_OUTPUT_MSB_REG(DCB03OU)
;  Instance name Timer16_2, User Module Timer16
;       Instance name Timer16_2, Block Name TIMER16_LSB(DBB11)
	db		34h, 00h		;Timer16_2_FUNC_LSB_REG(DBB11FN)
	db		35h, 07h		;Timer16_2_INPUT_LSB_REG(DBB11IN)
	db		36h, 40h		;Timer16_2_OUTPUT_LSB_REG(DBB11OU)
;       Instance name Timer16_2, Block Name TIMER16_MSB(DCB12)
	db		38h, 20h		;Timer16_2_FUNC_MSB_REG(DCB12FN)
	db		39h, 37h		;Timer16_2_INPUT_MSB_REG(DCB12IN)
	db		3ah, 68h		;Timer16_2_OUTPUT_MSB_REG(DCB12OU)
...
LoadConfigTBL_time_test_Ordered:
;  Ordered Global Register values
	M8C_SetBank0
	mov	reg[00h], 10h		; Port_0_Data register (PRT0DR)
	M8C_SetBank1
	mov	reg[00h], d0h		; Port_0_DriveMode_0 register (PRT0DM0)
	mov	reg[01h], 3fh		; Port_0_DriveMode_1 register (PRT0DM1)
	M8C_SetBank0
	mov	reg[03h], 2fh		; Port_0_DriveMode_2 register (PRT0DM2)
	...
	M8C_SetBank1
	mov	reg[04h], d7h		; Port_1_DriveMode_0 register (PRT1DM0)
	mov	reg[05h], 68h		; Port_1_DriveMode_1 register (PRT1DM1)
	M8C_SetBank0
	mov	reg[07h], 28h		; Port_1_DriveMode_2 register (PRT1DM2)
	mov	reg[06h], 83h		; Port_1_GlobalSelect register (PRT1GS)
	M8C_SetBank1
	mov	reg[06h], 40h		; Port_1_IntCtrl_0 register (PRT1IC0)
	mov	reg[07h], 40h		; Port_1_IntCtrl_1 register (PRT1IC1)
	M8C_SetBank0
	mov	reg[05h], 40h		; Port_1_IntEn register (PRT1IE)
	mov	reg[08h], 00h		; Port_2_Data register (PRT2DR)
	M8C_SetBank1
	mov	reg[08h], 7ah		; Port_2_DriveMode_0 register (PRT2DM0)
	mov	reg[09h], 85h		; Port_2_DriveMode_1 register (PRT2DM1)
	M8C_SetBank0
	mov	reg[0bh], 85h		; Port_2_DriveMode_2 register (PRT2DM2)
	mov	reg[0ah], 7ah		; Port_2_GlobalSelect register (PRT2GS)
	M8C_SetBank1
