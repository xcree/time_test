...
export LoadConfig_time_test
export _LoadConfig_time_test
...
_LoadConfigInit:
 LoadConfigInit:
	...
	lcall	LoadConfig_time_test
	lcall	LoadConfigTBL_time_test_Ordered
...
;---------------------------------------------------------------------------
; Load Configuration time_test
;
;    Load configuration registers for time_test.
...
;               CUR_PP
;
_LoadConfig_time_test:
 LoadConfig_time_test:
    RAM_PROLOGUE RAM_USE_CLASS_4
    ...
    asr     a                       ; Store in carry flag
                                    ; Load bank 0 table:
    mov     A, >LoadConfigTBL_time_test_Bank0
    mov     X, <LoadConfigTBL_time_test_Bank0
    lcall   LoadConfig              ; Load the bank 0 values

    mov     a, 1                    ; Specify bank 1
    asr     a                       ; Store in carry flag
                                    ; Load bank 1 table:
    mov     A, >LoadConfigTBL_time_test_Bank1
    mov     X, <LoadConfigTBL_time_test_Bank1
